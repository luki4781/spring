...
<div align="center" style="margin: 10px;">
	...
	<div style="width: 80%; height:70%; background-color: #4FC9DE; font-size: 10pt; overflow-y: scroll; word-break: break-all;" align="left" id="log">
	</div>
...
<script>
	...
	ws.onmessage = function(e){
		...
		if(obj.msg != null){
			document.getElementById("log").innerHTML += "["+obj.sender+"] : "+obj.msg+"<br/>";
		...
		if(obj.mode == "join"){
			document.getElementById("log").innerHTML += "["+obj.sender+"]님이 입장 하셨습니다.<br/>";
		}
		if(obj.mode == "closed"){
			document.getElementById("log").innerHTML += "["+obj.sender+"]님이 퇴장 하셨습니다.<br/>";
		}
	} 
</script>